((typeof self !== 'undefined' ? self : this)["webpackJsonpamisEditor"] = (typeof self !== 'undefined' ? self : this)["webpackJsonpamisEditor"] || []).push([[90],{
...
var workerManager_WorkerManager = /** @class */ (function () {
    ...
    WorkerManager.prototype._getClient = function () {
        var _this = this;
        if (!this._client) {
            this._worker = monaco_editor_core["f" /* editor */].createWebWorker({
            ...
            if (this._defaults.getEagerModelSync()) {
                p = p.then(function (worker) {
                    if (_this._worker) {
                        return _this._worker.withSyncedResources(monaco_editor_core["f" /* editor */]
                            .getModels()
...
var languageFeatures_LibFiles = /** @class */ (function () {
    ...
    LibFiles.prototype.getOrCreateModel = function (uri) {
        var model = monaco_editor_core["f" /* editor */].getModel(uri);
        if (model) {
            return model;
        }
        if (this.isLibFile(uri) && this._hasFetchedLibFiles) {
            return monaco_editor_core["f" /* editor */].createModel(this._libFiles[uri.path.slice(1)], 'typescript', uri);
        }
        return null;
    };
...
var languageFeatures_DiagnosticsAdapter = /** @class */ (function (_super) {
    ...
    function DiagnosticsAdapter(_libFiles, _defaults, _selector, worker) {
            ...
            var visibleSubscription = model.onDidChangeAttached(function () {
                ...
                if (onlyVisible) {
                    if (model.isAttachedToEditor()) {
                        ...
                        monaco_editor_core["f" /* editor */].setModelMarkers(model, _this._selector, []);
                    }
                }
            });
        ...
        _this._disposables.push(monaco_editor_core["f" /* editor */].onDidCreateModel(function (model) { return onModelAdd(model); }));
        _this._disposables.push(monaco_editor_core["f" /* editor */].onWillDisposeModel(onModelRemoved));
        _this._disposables.push(monaco_editor_core["f" /* editor */].onDidChangeModelLanguage(function (event) {
            onModelRemoved(event.model);
            onModelAdd(event.model);
        }));
        _this._disposables.push({
            dispose: function () {
                for (var _i = 0, _a = monaco_editor_core["f" /* editor */].getModels(); _i < _a.length; _i++) {
                    var model = _a[_i];
        ...
        monaco_editor_core["f" /* editor */].getModels().forEach(function (model) { return onModelAdd(model); });
        return _this;
    }
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        relatedUris = diagnostics
                            ...
                            return relatedInformation.file ? monaco_editor_core["e" /* Uri */].parse(relatedInformation.file.fileName) : null;
                        });
                    ...
                    case 3:
                        ...
                        monaco_editor_core["f" /* editor */].setModelMarkers(model, this._selector, diagnostics.map(function (d) { return _this._convertDiagnostics(model, d); }));
                        return [2 /*return*/];
                }
            });
        });
    ...
    DiagnosticsAdapter.prototype._convertDiagnostics = function (model, diag) {
        ...
        if (diag.reportsUnnecessary) {
            tags.push(monaco_editor_core["c" /* MarkerTag */].Unnecessary);
        }
        if (diag.reportsDeprecated) {
            tags.push(monaco_editor_core["c" /* MarkerTag */].Deprecated);
        }
        return {
    ...
    DiagnosticsAdapter.prototype._convertRelatedInformation = function (model, relatedInformation) {
        ...
        relatedInformation.forEach(function (info) {
            ...
            if (info.file) {
                var relatedResourceUri = monaco_editor_core["e" /* Uri */].parse(info.file.fileName);
    ...
    DiagnosticsAdapter.prototype._tsDiagnosticCategoryToMarkerSeverity = function (category) {
        switch (category) {
            case DiagnosticCategory.Error:
                return monaco_editor_core["b" /* MarkerSeverity */].Error;
            case DiagnosticCategory.Message:
                return monaco_editor_core["b" /* MarkerSeverity */].Info;
            case DiagnosticCategory.Warning:
                return monaco_editor_core["b" /* MarkerSeverity */].Warning;
            case DiagnosticCategory.Suggestion:
                return monaco_editor_core["b" /* MarkerSeverity */].Hint;
        }
        return monaco_editor_core["b" /* MarkerSeverity */].Info;
    };
...
var languageFeatures_SuggestAdapter = /** @class */ (function (_super) {
            ...
            return languageFeatures_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        wordRange = new monaco_editor_core["d" /* Range */](position.lineNumber, wordInfo.startColumn, position.lineNumber, wordInfo.endColumn);
                        resource = model.uri;
                    ...
                    case 2:
                        ...
                        suggestions = info.entries.map(function (entry) {
                            ...
                            if (entry.replacementSpan) {
                                ...
                                range = new monaco_editor_core["d" /* Range */](p1.lineNumber, p1.column, p2.lineNumber, p2.column);
                            }
                            var tags = [];
                            if (((_a = entry.kindModifiers) === null || _a === void 0 ? void 0 : _a.indexOf('deprecated')) !== -1) {
                                tags.push(monaco_editor_core["g" /* languages */].CompletionItemTag.Deprecated);
                            }
                            return {
                                uri: resource,
                                position: position,
    ...
    SuggestAdapter.convertKind = function (kind) {
        switch (kind) {
            ...
            case Kind.keyword:
                return monaco_editor_core["g" /* languages */].CompletionItemKind.Keyword;
            case Kind.variable:
            case Kind.localVariable:
                return monaco_editor_core["g" /* languages */].CompletionItemKind.Variable;
            case Kind.memberVariable:
            case Kind.memberGetAccessor:
            case Kind.memberSetAccessor:
                return monaco_editor_core["g" /* languages */].CompletionItemKind.Field;
            case Kind.function:
            case Kind.memberFunction:
            case Kind.constructSignature:
            case Kind.callSignature:
            case Kind.indexSignature:
                return monaco_editor_core["g" /* languages */].CompletionItemKind.Function;
            case Kind.enum:
                return monaco_editor_core["g" /* languages */].CompletionItemKind.Enum;
            case Kind.module:
                return monaco_editor_core["g" /* languages */].CompletionItemKind.Module;
            case Kind.class:
                return monaco_editor_core["g" /* languages */].CompletionItemKind.Class;
            case Kind.interface:
                return monaco_editor_core["g" /* languages */].CompletionItemKind.Interface;
            case Kind.warning:
                return monaco_editor_core["g" /* languages */].CompletionItemKind.File;
        }
        return monaco_editor_core["g" /* languages */].CompletionItemKind.Property;
    };
...
var languageFeatures_SignatureHelpAdapter = /** @class */ (function (_super) {
    ...
    SignatureHelpAdapter._toSignatureHelpTriggerReason = function (context) {
        switch (context.triggerKind) {
            case monaco_editor_core["g" /* languages */].SignatureHelpTriggerKind.TriggerCharacter:
            ...
            case monaco_editor_core["g" /* languages */].SignatureHelpTriggerKind.ContentChange:
                return context.isRetrigger ? { kind: 'retrigger' } : { kind: 'invoked' };
            case monaco_editor_core["g" /* languages */].SignatureHelpTriggerKind.Invoke:
            default:
                return { kind: 'invoked' };
        }
    };
                        ...
                        return [2 /*return*/, entries.map(function (entry) {
                                return {
                                    ...
                                    kind: entry.isWriteAccess
                                        ? monaco_editor_core["g" /* languages */].DocumentHighlightKind.Write
                                        : monaco_editor_core["g" /* languages */].DocumentHighlightKind.Text
                                };
                            })];
                }
            });
            ...
            return languageFeatures_generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._libFiles.fetchLibFilesIfNecessary(entries.map(function (entry) { return monaco_editor_core["e" /* Uri */].parse(entry.fileName); }))];
                    case 3:
                        // Fetch lib files if necessary
                        _a.sent();
                        if (model.isDisposed()) {
                        ...
                        for (_i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
                            entry = entries_1[_i];
                            uri = monaco_editor_core["e" /* Uri */].parse(entry.fileName);
                            ...
                            if (refModel) {
                                ...
                                matchedLibFile = monaco_contribution["a" /* typescriptDefaults */].getExtraLibs()[entry.fileName];
                                if (matchedLibFile) {
                                    libModel = monaco_editor_core["f" /* editor */].createModel(matchedLibFile.content, 'typescript', uri);
                                    return [2 /*return*/, {
                                            uri: uri,
                    ...
                    case 2:
                        ...
                        convert = function (bucket, item, containerLabel) {
                            var result = {
                                name: item.text,
                                detail: '',
                                kind: (outlineTypeTable[item.kind] || monaco_editor_core["g" /* languages */].SymbolKind.Variable),
...
outlineTypeTable[Kind.module] = monaco_editor_core["g" /* languages */].SymbolKind.Module;
outlineTypeTable[Kind.class] = monaco_editor_core["g" /* languages */].SymbolKind.Class;
outlineTypeTable[Kind.enum] = monaco_editor_core["g" /* languages */].SymbolKind.Enum;
outlineTypeTable[Kind.interface] = monaco_editor_core["g" /* languages */].SymbolKind.Interface;
outlineTypeTable[Kind.memberFunction] = monaco_editor_core["g" /* languages */].SymbolKind.Method;
outlineTypeTable[Kind.memberVariable] = monaco_editor_core["g" /* languages */].SymbolKind.Property;
outlineTypeTable[Kind.memberGetAccessor] = monaco_editor_core["g" /* languages */].SymbolKind.Property;
outlineTypeTable[Kind.memberSetAccessor] = monaco_editor_core["g" /* languages */].SymbolKind.Property;
outlineTypeTable[Kind.variable] = monaco_editor_core["g" /* languages */].SymbolKind.Variable;
outlineTypeTable[Kind.const] = monaco_editor_core["g" /* languages */].SymbolKind.Variable;
outlineTypeTable[Kind.localVariable] = monaco_editor_core["g" /* languages */].SymbolKind.Variable;
outlineTypeTable[Kind.variable] = monaco_editor_core["g" /* languages */].SymbolKind.Variable;
outlineTypeTable[Kind.function] = monaco_editor_core["g" /* languages */].SymbolKind.Function;
outlineTypeTable[Kind.localFunction] = monaco_editor_core["g" /* languages */].SymbolKind.Function;
// --- formatting ----
...
// --- rename ----
var languageFeatures_RenameAdapter = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        for (_i = 0, renameLocations_1 = renameLocations; _i < renameLocations_1.length; _i++) {
                            ...
                            resource_1 = monaco_editor_core["e" /* Uri */].parse(renameLocation.fileName);
                            model_1 = monaco_editor_core["f" /* editor */].getModel(resource_1);
                            if (model_1) {
                                edits.push({
                                    resource: resource_1,
                                    edit: {
...
var languageFeatures_InlayHintsAdapter = /** @class */ (function (_super) {
    ...
    InlayHintsAdapter.prototype._convertHintKind = function (kind) {
        switch (kind) {
            case 'Parameter':
                return monaco_editor_core["g" /* languages */].InlayHintKind.Parameter;
            case 'Type':
                return monaco_editor_core["g" /* languages */].InlayHintKind.Type;
            default:
                return monaco_editor_core["g" /* languages */].InlayHintKind.Other;
        }
    };
...
function setupMode(defaults, modeId) {
    ...
    monaco_editor_core["g" /* languages */].registerCompletionItemProvider(modeId, new languageFeatures_SuggestAdapter(worker));
    monaco_editor_core["g" /* languages */].registerSignatureHelpProvider(modeId, new languageFeatures_SignatureHelpAdapter(worker));
    monaco_editor_core["g" /* languages */].registerHoverProvider(modeId, new QuickInfoAdapter(worker));
    monaco_editor_core["g" /* languages */].registerDocumentHighlightProvider(modeId, new languageFeatures_OccurrencesAdapter(worker));
    monaco_editor_core["g" /* languages */].registerDefinitionProvider(modeId, new languageFeatures_DefinitionAdapter(libFiles, worker));
    monaco_editor_core["g" /* languages */].registerReferenceProvider(modeId, new languageFeatures_ReferenceAdapter(libFiles, worker));
    monaco_editor_core["g" /* languages */].registerDocumentSymbolProvider(modeId, new languageFeatures_OutlineAdapter(worker));
    monaco_editor_core["g" /* languages */].registerDocumentRangeFormattingEditProvider(modeId, new FormatAdapter(worker));
    monaco_editor_core["g" /* languages */].registerOnTypeFormattingEditProvider(modeId, new FormatOnTypeAdapter(worker));
    monaco_editor_core["g" /* languages */].registerCodeActionProvider(modeId, new CodeActionAdaptor(worker));
    monaco_editor_core["g" /* languages */].registerRenameProvider(modeId, new languageFeatures_RenameAdapter(worker));
    monaco_editor_core["g" /* languages */].registerInlayHintsProvider(modeId, new languageFeatures_InlayHintsAdapter(worker));
...
//# sourceMappingURL=amisEditor.common.90.js.map